...
export default function useGlobalStyles() {
 ...
 return StyleSheet.create({
  ...
  containerScroll: {padding: 18, backgroundColor: colors.background }, 
  ...
  input: { width: "58%", height:35, borderColor:colors.gray, borderWidth: 1, borderRadius: 4, textAlignVertical: "center", 
  ...
  label: { fontWeight: "bold", fontSize: 14, color: colors.grayinv,},
