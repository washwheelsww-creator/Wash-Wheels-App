...
const lightColors = { primary: "#0868cfff", danger:  "#FF3B30", gray:    "#ccc", background: "#fff", text:    "#333",}
const darkColors = { primary: "#274bb1ff", danger:  "#FF453AFF", gray:    "#555", background: "#000", text:    "#eee",}
...
export default function useGlobalStyles() {
 ...
 return StyleSheet.create({
  ...
  containerScroll: {padding: 16, backgroundColor: colors.background }, 
  ...
  locationButton: { backgroundColor: '#797e83ff', padding: 10, borderRadius: 8, alignSelf: 'center', marginBottom: 8, height: 50, justifyContent: 'center', },
  ...
  screenBg: { flex:1, backgroundColor:'#fff' },
